...
export type CategorySwatch = {
  ...
  soft: string;
  /** Pastel disc behind the category's icon in the "Where it went" sidebar.
   *  A step stronger than `soft`, which sits behind text and has to stay
   *  quiet — this one holds a small line-art glyph and disappears if it's as
   *  pale as the chip. */
  badge: string;
...
const SWATCHES: CategorySwatch[] = [
  { bar: "bg-rose-500", text: "text-rose-600", ring: "ring-rose-400", soft: "bg-rose-100 text-rose-700", badge: "bg-rose-200 text-rose-800", gradient: "from-pink-200 via-fuchsia-200 to-purple-300", gradientSelected: "from-pink-300 via-fuchsia-300 to-purple-400" },
  { bar: "bg-sky-500", text: "text-sky-600", ring: "ring-sky-400", soft: "bg-sky-100 text-sky-700", badge: "bg-sky-200 text-sky-800", gradient: "from-cyan-200 via-sky-200 to-indigo-200", gradientSelected: "from-cyan-300 via-sky-300 to-indigo-300" },
  { bar: "bg-amber-500", text: "text-amber-600", ring: "ring-amber-400", soft: "bg-amber-100 text-amber-700", badge: "bg-amber-200 text-amber-800", gradient: "from-yellow-200 to-orange-200", gradientSelected: "from-yellow-300 to-orange-300" },
  { bar: "bg-emerald-500", text: "text-emerald-600", ring: "ring-emerald-400", soft: "bg-emerald-100 text-emerald-700", badge: "bg-emerald-200 text-emerald-800", gradient: "from-lime-200 to-emerald-200", gradientSelected: "from-lime-300 to-emerald-300" },
  { bar: "bg-violet-500", text: "text-violet-600", ring: "ring-violet-400", soft: "bg-violet-100 text-violet-700", badge: "bg-violet-200 text-violet-800", gradient: "from-violet-200 via-purple-200 to-pink-200", gradientSelected: "from-violet-300 via-purple-300 to-pink-300" },
  { bar: "bg-orange-500", text: "text-orange-600", ring: "ring-orange-400", soft: "bg-orange-100 text-orange-700", badge: "bg-orange-200 text-orange-800", gradient: "from-orange-200 to-amber-200", gradientSelected: "from-orange-300 to-amber-300" },
  { bar: "bg-teal-500", text: "text-teal-600", ring: "ring-teal-400", soft: "bg-teal-100 text-teal-700", badge: "bg-teal-200 text-teal-800", gradient: "from-emerald-200 to-cyan-200", gradientSelected: "from-emerald-300 to-cyan-300" },
  { bar: "bg-fuchsia-500", text: "text-fuchsia-600", ring: "ring-fuchsia-400", soft: "bg-fuchsia-100 text-fuchsia-700", badge: "bg-fuchsia-200 text-fuchsia-800", gradient: "from-fuchsia-200 via-pink-200 to-rose-200", gradientSelected: "from-fuchsia-300 via-pink-300 to-rose-300" },
];
